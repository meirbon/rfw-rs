...
use crate::scene::r2d::{D2Instance, D2Mesh};
use crate::scene::utils::Flags;
use crate::utils::collections::{FlaggedIterator, FlaggedIteratorMut, TrackedStorage};
...
impl Scene {
    ...
    fn create_loaders() -> HashMap<String, Box<dyn ObjectLoader>> {
        ...
        loaders.insert(
            String::from("gltf"),
            Box::new(crate::scene::gltf::GltfLoader::default()),
        );
        loaders.insert(
            String::from("glb"),
            Box::new(crate::scene::gltf::GltfLoader::default()),
        ...
        loaders.insert(
            String::from("obj"),
            Box::new(crate::scene::obj::ObjLoader::default()),
        );
