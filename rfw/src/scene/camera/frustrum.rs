...
impl FrustrumG {
    ...
    pub fn new(camera: &crate::scene::camera::Camera) -> FrustrumG {
...
impl From<&crate::scene::camera::Camera> for FrustrumG {
    fn from(camera: &crate::scene::camera::Camera) -> Self {
        Self::new(camera)
    }
}
...
mod tests {
    #[test]
    fn frustrum_works() {
        use crate::scene::{Camera, FrustrumG, FrustrumResult};
