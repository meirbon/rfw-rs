...
impl Backend for VulkanBackend {
    ...
    fn set_2d_instances(&mut self, mesh: usize, instances: InstancesData2D<'_>) {
        unsafe {
            ffi::set_2d_instances(
                ...
                mesh as u32,
                ffi::InstancesData2D {
                    matrices: instances.matrices.as_ptr() as *const ffi::Vector4x4,
    ...
    fn set_3d_mesh(&mut self, id: usize, data: MeshData3D<'_>) {
        unsafe {
            ...
            std::ptr::write(
                &mut bounds as *mut ffi::Aabb as *mut ffi::Vector4,
                *(&data.bounds.min as *const Vec3 as *const ffi::Vector4),
            );
            std::ptr::write(
                (&mut bounds as *mut ffi::Aabb as *mut ffi::Vector4).add(1),
    ...
    fn set_3d_instances(&mut self, mesh: usize, instances: InstancesData3D<'_>) {
        unsafe {
            ...
            std::ptr::write(
                &mut bounds as *mut ffi::Aabb as *mut ffi::Vector4,
                *(&instances.local_aabb.min as *const Vec3 as *const ffi::Vector4),
            );
            std::ptr::write(
                (&mut bounds as *mut ffi::Aabb as *mut ffi::Vector4).add(1),
...
mod tests {
    ...
    fn test_layout() {
        ...
        assert_eq!(
            ...
            std::mem::size_of::<ffi::Vector4>()
        );
        assert_eq!(
            std::mem::size_of::<Vec3>(),
            std::mem::size_of::<ffi::Vector3>()
        );
        assert_eq!(
            std::mem::size_of::<Vec2>(),
            std::mem::size_of::<ffi::Vector2>()
        );
        assert_eq!(
            std::mem::size_of::<Mat4>(),
            std::mem::size_of::<ffi::Vector4x4>()
        );
