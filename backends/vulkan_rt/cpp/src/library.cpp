						  ...
						  unsigned int width, unsigned int height, double scale)
{
	...
	case XLIB_HANDLE: {
		...
		CheckVK(instance.createXlibSurfaceKHR(&createInfoKhr, nullptr, &surface));
		break;
	}
	case XCB_HANDLE: {
		...
		CheckVK(instance.createXcbSurfaceKHR(&createInfoKhr, nullptr, &surface));
		break;
	}
	case WAYLAND_HANDLE: {
		...
		CheckVK(instance.createWaylandSurfaceKHR(&createInfoKhr, nullptr, &surface));
		break;
	}
	}
	// TODO
